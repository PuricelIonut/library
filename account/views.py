...
def change_password_view(request):
    ...
    return render(request, 'change-password.html', {'change_password':form})
...
def password_reset_view(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            user = get_user_model().object.filter(Q(email=user_email)).first()
            if user:
    ...
    return render(request, 'reset-password/reset-password.html', {'form': form})
"""